...
def main2():
    ...
    with tab2:
        ...
        with st.container():
            ...
            with col1:
                st.markdown("<h3 style='color: black;'>Describe the person:</h3>", unsafe_allow_html=True)
                text_input1 = st.text_input("Describe the person:", label_visibility='collapsed')
        ...
        with st.container():
            ...
            # Remove images from path if there is no text_input1
            if not text_input1:
